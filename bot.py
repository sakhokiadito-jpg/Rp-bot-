...
CARS = {
    ...
    23:  ("Audi RS4 Avant — 450 HP", 40_000),
    ...
    34:  ("Mercedes-AMG C63 Coupe W204 — 487 HP", 30_000),
    35:  ("Cadillac CTS — 320 HP", 33_000),
    36:  ("Subaru BRZ — 220 HP", 16_000),
    37:  ("Mercedes G65 — 575 HP", 47_000),
    ...
    50:  ("Mercedes-Benz CL65 AMG — 630 HP", 50_000),
    ...
    80:  ("BMW M4 F82 Competition — 450 HP", 94_000),
    ...
    87:  ("BMW M5 F90 — 650 HP", 146_000),
    88:  ("Mercedes-Benz E63 AMG — 630 HP", 119_000),
    89:  ("Mercedes-AMG GT — 640 HP", 154_000),
    90:  ("Audi RS7 — 630 HP", 246_000),
    91:  ("BMW M8 F92 — 625 HP", 277_000),
    92:  ("Dodge Challenger SRT — 780 HP", 231_000),
    93:  ("Chevrolet Corvette C7 — 600 HP", 145_000),
    94:  ("Porsche Panamera Turbo — 520 HP", 85_000),
    95:  ("RAM TRX — 712 HP", 254_000),
    96:  ("BMW i8 — 420 HP", 145_000),
    97:  ("Lamborghini Urus — 650 HP", 385_000),
    98:  ("BMW X7 M50i — 400 HP", 154_000),
    99:  ("BMW i7 — 544 HP", 231_000),
    100: ("Nissan GT-R R35 — 500 HP", 92_300),
    101: ("BMW X6 M F86 — 575 HP", 80_800),
    102: ("Porsche 911 Carrera 4 — 272 HP", 154_000),
    103: ("Mercedes G-Class — 575 HP", 210_000),
    104: ("Dodge Viper — 650 HP", 185_000),
    105: ("Cadillac Escalade-V — 682 HP", 230_000),
    106: ("Range Rover Sport SV — 542 HP", 198_000),
    107: ("BMW M5 G90 2025 — 717 HP", 250_000),
    108: ("Mercedes-Maybach S680 W223 — 603 HP", 320_000),
    109: ("Ford Mustang 2024 — 500 HP", 110_000),
    110: ("Mercedes-Benz S-Class W222 — 612 HP", 140_000),
    111: ("Chevrolet Camaro ZL1 — 650 HP", 95_000),
    112: ("Mercedes-Benz CLS C218 — 408 HP", 160_000),
    113: ("Bentley Continental GT — 640 HP", 220_000),
    114: ("Audi RS7 C8 — 600 HP", 185_000),
    115: ("Toyota Supra A90 — 340 HP", 85_000),
    116: ("Land Rover Defender 110 V8 — 525 HP", 195_000),
    117: ("Ford F-150 Raptor R — 720 HP", 265_000),
    118: ("Jeep Gladiator Rubicon — 285 HP", 200_000),
    119: ("Lamborghini Gallardo Spyder — 650 HP", 390_000),
    120: ("Jeep Grand Cherokee SRT8 — 475 HP", 180_000),
    121: ("Porsche 911 GT3 RS — 525 HP", 280_000),
    122: ("Hummer H1 Alpha — 300 HP", 145_000),
    123: ("BMW M2 G87 — 460 HP", 82_000),
    124: ("Ford F-650 Super Duty — 330 HP", 120_000),
    125: ("Porsche Carrera GT — 612 HP", 650_000),
    126: ("Lexus LFA — 560 HP", 450_000),
    127: ("Porsche 918 Spyder — 887 HP", 950_000),
    128: ("Mercedes-Benz CLK GTR — 612 HP", 13_000_000),
    129: ("Rolls-Royce Cullinan Blue — 555 HP", 1_500_000),
    130: ("Lamborghini Aventador Orange — 700 HP", 950_000),
    131: ("Rolls-Royce Dawn — 570 HP", 1_200_000),
    132: ("Ferrari F40 — 478 HP", 2_500_000),
    133: ("Lamborghini Aventador SVJ — 790 HP", 850_000),
    134: ("Pagani Zonda Cinque — 764 HP", 9_500_000),
    135: ("Lamborghini Veneno — 750 HP", 3_500_000),
    136: ("Ferrari LaFerrari — 949 HP", 3_600_000),
    137: ("Bugatti Chiron Sport — 1500 HP", 4_200_000),
    138: ("Koenigsegg Jesko Attack — 1280 HP", 5_500_000),
    139: ("Mercedes G-Class 6x6 — 544 HP", 950_000),
    140: ("McLaren 720S — 710 HP", 450_000),
    141: ("McLaren P1 — 920 HP", 1_500_000),
    142: ("Bugatti Veyron — 1001 HP", 1_900_000),
    143: ("Koenigsegg Agera RS — 1115 HP", 3_000_000),
}
...
async def buy_car(message: types.Message):
    ...
    if car_id not in CARS:
        await message.answer(f"❌ Авто №{car_id} не найдено. Доступны: 1–143")
        return
